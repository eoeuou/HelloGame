...
#include <jni.h>
/* Header for class org_cocos2dx_ckbase_CKNotification */

#ifndef _Included_org_cocos2dx_ckbase_CKNotification
#define _Included_org_cocos2dx_ckbase_CKNotification
#ifdef __cplusplus
extern "C" {
#endif
/*
